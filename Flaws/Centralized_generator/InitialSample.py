...
class InitialSample : #Initialize path,comment and relevancy parameters OK
...
class InputSample(InitialSample) : #Initialize the type of input and the code parameters of the class OK
    def __init__(self, initialSample) : #XML tree in parameter
        InitialSample.__init__(self,initialSample)
        self.inputType = initialSample.find("inputType").text

class Sanitize(InitialSample) : #Initialize rules, safety, code and escape OK
    def __init__(self, initialSample) : #XML tree in parameter
        InitialSample.__init__(self,initialSample)
        safety = initialSample.find("safety")

        #Used only for Injection generation
        ...
        #Escape of type " -> \" ? (TODO : improve that)
        self.escape = 0
